...
#Plot 3 - Energy Sub Metering over a 2-day period.
png("plot3.png")
...
legend("topright", cex=0.9, lwd=1, lty = 1, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
